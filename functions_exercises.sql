...
SELECT CONCAT (datediff(curdate(), hire_date )) AS 'Days worked for employees born in the 90''s starting with the oldest' FROM employees WHERE year(hire_date) BETWEEN 1990 AND 1999 AND month(birth_date) = 12 AND day(birth_date) = 25;